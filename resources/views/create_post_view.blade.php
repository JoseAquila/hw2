    ...
    <body>
        <header>
            <nav>
                ...
                <div id="links">
                    <a class="button" href='{{ url("home") }}'>MyHome</a>
                ...
                <div id="newpost">
                    <div class= 'hidden_for_post'>
                        ...
                        <div id='pensiero' class='hidden'>
                            <form class = 'invia_post' method='post' action="{{route('create_post')}}"  autocomplete="off">
                                    @csrf
                    ...
                    <div id="dispatch_result_success" class="hidden">
                        ...
                        <a id="newpost_success" href='{{ url("create_post_view") }}'>Nuovo post</a><br>
                        <a href='{{ url("home") }}'>Vai alla home</a>
                    </div>
                    <div id="dispatch_result_fail" class="hidden">
                        <span>Errore nella creazione del post</span><br>
                        <a class="button_fail" href='{{ url("create_post_view") }}'>Riprova</a>
                        <a class="button_fail" href='{{ url("home") }}'>MyHome</a>
                    </div>
                </div>
        </section>
    </body>
