<html>
  <head>
        <script>
            const BASE_URL = "{{ url('/') }}/";
            const CSRF_TOKEN = '{{ csrf_token() }}'//dove non uso @csrf
        </script>
        <title>MyFootball - Home</title>
        <link rel="stylesheet" href="{{url ('css/myhome.css') }}" />
        <script src='{{ url("js/myhome.js") }}' defer></script>
        <script src='{{ url("js/apiCat.js") }}' defer></script>
  ...
  <body>
        <header>
            <nav>
                ...
                <div id="links">
                    ...
                    <a class="button" href='{{ url("searchView") }}'>Cerca i tuoi amici</a>
    ...
    <article>
        ...
        <div>
            <img id='casetta' src="{{url ('images/home.png') }}"/>
            <div id='homepage'>
                Homepage
            </div>
        </div>
        ...
        <section id='post'>
            ...
            <a class="button" href = '{{ url("create_post_view") }}'>Nuovo post</a>

        </section>

        <section id="feed" data-source="{{route('feed')}}">  <!-- qui si caricheranno i post-->
                    ...
                    <article class="post">
                        ...
                        <div class="comments">
                            ...
                            <div class="comment_form">
                                <form method='post' action="{{route('add_comment')}}"  autocomplete="off" >
